    ...
    public partial class NotificationTests
    {
        ...
        public class When_a_card_payment_notification_arrives
        {
            ...
            private Establish context = () => {
                ...
                {
                    CardPaymentNotificationCallback = async response => {
                        await Task.Delay(1);
            ...
            private Because of = () => { Response = NotificationProcessor.ProcessNotificationBodyAsync(NotificationBody).GetAwaiter().GetResult(); };

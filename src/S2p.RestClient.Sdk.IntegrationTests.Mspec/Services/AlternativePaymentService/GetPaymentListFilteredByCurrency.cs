...
namespace S2p.RestClient.Sdk.IntegrationTests.Mspec.Services.AlternativePaymentService
{
    public partial class PaymentServiceTests
    {
        ...
        public class When_requesting_payment_list_filtered_by_currency
        {
            ...
            private Establish context = () => {
                ...
                PaymentsFilter = new AlternativePaymentsFilter { startDate = StartDate, endDate = EndDate, pageSize = 100, currency = Currency };
            };
